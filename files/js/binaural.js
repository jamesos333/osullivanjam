...
function togglePlay() {
    ...
    if (AudioContext) {
        ...
        alert(
            "Sorry, but the Web Audio API is not supported by your browser. Please, consider upgrading to the " +
                "latest version or downloading Google Chrome or Mozilla Firefox."
        );
    }
    ...
    this.osc1.frequency.value = document.getElementById("freq1").value;

    this.osc2 = context.createOscillator();
    this.osc2.frequency.value = document.getElementById("freq2").value;
