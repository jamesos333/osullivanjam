...
function getButton($buttonParameters) {
    ...
    return "<a href='$linkHref'><img src='$imgSrc' width='300' height='120' alt='$imgAlt' class='$imgClass'></a>";
}
?>
...
<table preload="mousedown" preload-images="true" class="buttontable">
    ...
    <tr>
        ...
        <th><a href='/moth'><img src="<?= IMAGE_PATH_INDEX . 'eye.gif' ?>" width="300" height="276" alt="" class="eye"></a></th>
